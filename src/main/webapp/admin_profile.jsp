	    ...
	    <div class="sidebar">
	      ...
	      <nav class="mt-2">
	        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			  ...
			  <li class="nav-item">
	            <a href="<%=request.getContextPath()%>/showAdminProfileForm" class="nav-link active">
							...
							<div class="card card-info">
								...
								<div class="card-body">
			                            ...
			                            <fieldset class="form-group">
				                            ...
				                            <span><c:out value='${user.adminid}' /></span>
				                            <input type="hidden" value="<c:out value='${user.adminid}' />" class="form-control" name="adid" required="required">
				                        </fieldset>
				                        
				                        <fieldset class="form-group">
				                            <label>Manager ID</label><br>
				                            <span><c:out value='${user.managerid}' /></span>
				                            <input type=hidden value="<c:out value='${user.managerid}' />" class="form-control" name="managerid" required="required">
				                        </fieldset>
				
				                        <fieldset class="form-group">
				                            <label>Admin Name</label> <input type="text" value="<c:out value='${user.adminname}' />" class="form-control" name="adname" required="required">
				                        </fieldset>
				
				                        <fieldset class="form-group">
				                            <label>Admin Phone No</label> <input type="text" value="<c:out value='${user.adminphoneno}' />" class="form-control" name="adphoneno" required="required">
				                        </fieldset>
