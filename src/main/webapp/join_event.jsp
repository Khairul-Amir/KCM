	    ...
	    <div class="sidebar">
	      ...
	      <nav class="mt-2">
	        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
	          ...
	          <li class="nav-item">
	            <a href="<%=request.getContextPath()%>/listeventmember"  class="nav-link active">
	              <i class="nav-icon fas fa-user"></i>
	              <p>
	                View New Events
	              </p>
							...
							<div class="card card-info">
								...
								<div class="card-body">
				                        ...
				                        <fieldset class="form-group">
				                            ...
				                            <span><c:out value='${event.feeid}' /></span> 
				                            <input type="hidden" value="<c:out value='${event.feeid}' />" class="form-control" name="fid" required="required">
				                        </fieldset>
				                        
				                        <fieldset class="form-group">
				                            <label>Event ID</label><br>
				                            <span><c:out value='${event.eventid}' /></span> 
				                            <input type="hidden" value="<c:out value='${event.eventid}' />" class="form-control" name="eid" required="required">
				                        </fieldset>
				                        
				                        <fieldset class="form-group">
				                            <label>Event Description</label><br>
				                            <span><c:out value='${event.eventdescription}' /></span> 
				                            <input type="hidden" value="<c:out value='${event.eventdescription}' />" class="form-control" name="edesc" required="required">
				                        </fieldset>
