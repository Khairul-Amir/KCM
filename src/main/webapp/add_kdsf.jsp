		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Add KDSF Details</h1>
						</div><!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
							  <li class="breadcrumb-item"><a href="#">Fee</a></li>
							  <li class="breadcrumb-item"><a href="#">Add</a></li>
							  <li class="breadcrumb-item"><a href="#">KDSF</a></li>
							</ol>
						</div><!-- /.col -->
					</div><!-- /.row -->
				</div><!-- /.container-fluid -->
						...
						<div class="col-md-12">
							<div class="card card-info">
								...
								<div class="card-body">
			                            ...
			                            <form action="addkdsffee" method="post">
				
				                        <fieldset class="form-group">
				                            <label>Fee ID</label><br>
				                            <span><c:out value='${kfee.feeid}' /></span> 
				                            <input type="hidden" value="<c:out value='${kfee.feeid}' />" class="form-control" name="fid" required="required">
				                        </fieldset>
				                        
				                        <fieldset class="form-group">
				                            <label>Fee Description</label><br>
				                            <span><c:out value='${kfee.feedesc}' /></span> 
				                        </fieldset>
