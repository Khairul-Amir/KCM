...
<% String session_id = (String)session.getAttribute("SAid"); %>
<!DOCTYPE html>
<html>
<head>
	    ...
	    <div class="sidebar">
	      ...
	      <nav class="mt-2">
	        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
	          ...
	          <li class="nav-item">
	            <a href="<%=request.getContextPath()%>/listadmin"  class="nav-link active">
	              <i class="nav-icon fas fa-user"></i>
	              <p>
	                Admin List
	              </p>
			                        ...
			                        <tbody>
			                            ...
			                            <c:forEach var="admin" items="${listAdmin}">
			                                ...
			                                <tr>
			                                    ...
			                                    <td>
			                                        <c:out value="${admin.managerid}" />
			                                    </td>
			                                    <td>
			                                        <c:out value="${admin.adminname}" />
			                                    </td>
			                                    <td>
			                                        <c:out value="${admin.adminphoneno}" />
			                                    </td>
			                                    
			                                    <td><a href="editadmin?id=<c:out value='${admin.adminid}' />">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="deleteadmin?id=<c:out value='${admin.adminid}' />">Delete</a></td>
			                                </tr>
			                            </c:forEach>
			                            <!-- } -->
			                        </tbody>
