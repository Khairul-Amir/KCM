...
<c:set var="userName" value="${member.membername}" scope="session" />
<c:set var="userID" value="${member.memberid}" scope="session" />
</head>
<body>
	<div class="wrapper">
	    ...
	    <div class="sidebar">
	      ...
	      <nav class="mt-2">
	        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			  ...
			  <li class="nav-item">
	            <a href="<%=request.getContextPath()%>/showmainpagemember" class="nav-link active">
				...
				<div class="row">
					...
					<div class="col-md-12" align="center">
						...
						<div class="card card-primary">
							<div>
								<h5>Welcome to Kiwanis Club Melaka System</h5>
							</div>
						</div>
						<!-- /.card -->
					</div>
