						...
						<div class="card card-primary">
							...
							<div class="card-body">
								...
								<table class="table table-bordered">
			                        ...
			                        <tbody>
			                            <!--   for (Todo todo: todos) {  -->
			                            <c:forEach var="applicant" items="${listApplicant}">
			                                ...
			                                <tr>
			                                    ...
			                                    <td>
			                                        <c:out value="${applicant.applicantstatus}" />
			                                    </td>
			                                    
			                                    <td><a href="showapplicantdetail?id=<c:out value='${applicant.memberid}' />">See Details</a></td>
			                                </tr>
			                            </c:forEach>
			                            <!-- } -->
			                        </tbody>
