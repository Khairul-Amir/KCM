                ...
                <div class="login-snip"><input id="tab-2" type="radio" name="tab" class="sign-up" checked><label for="tab-2" class="tab">Welcome To KCM MEMBERSHIP MANAGEMENT SYSTEM</label>
                    <div class="login-space">
                        <div class="sign-up-form">
                            ...
                            <div class="group"> <label for="user" class="label">Admin ID</label> 
							<input id="user" type="text" name="id" class="input" placeholder="Insert Member ID"> </div>
                            ...
                            <p><a href="index.jsp">Login As Member</a></p>
                        </div>
                    </div>
                </div>
            </div>
