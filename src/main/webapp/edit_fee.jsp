	    ...
	    <div class="sidebar">
	      ...
	      <nav class="mt-2">
	        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
	          ...
	          <li class="nav-item">
	            <a href="<%=request.getContextPath()%>/listfee"  class="nav-link active">
	              <i class="nav-icon fas fa-user"></i>
	              <p>
	                Fee List
	              </p>
							...
							<div class="card card-info">
								...
								<div class="card-body">
				                        ...
				                        <fieldset class="form-group">
				                            <label>Fee Description</label> <input type="text" value="<c:out value='${fee.feedesc}' />" class="form-control" name="fdesc" required="required">
				                        </fieldset>
				
				                        <fieldset class="form-group">
				                            <label>Fee Amount</label> <input type="text" value="<c:out value='${fee.feeamount}' />" class="form-control" name="famount" required="required">
				                        </fieldset>
				
				                        <fieldset class="form-group">
				                            <label>Fee Type</label> <input type="text" value="<c:out value='${fee.feetype}' />" class="form-control" name="ftype" required="required">
				                        </fieldset>
				                        
				                        <fieldset class="form-group">
				                            <label>Your ID</label> <input type="text" value="<c:out value='${fee.adminid}' />" class="form-control" name="faid" required="required">
				                        </fieldset>
