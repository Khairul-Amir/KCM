	    ...
	    <div class="sidebar">
	      ...
	      <nav class="mt-2">
	        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
	          ...
	          <li class="nav-item">
	            <a href="<%=request.getContextPath()%>/listfeepay"  class="nav-link active">
	              <i class="nav-icon fas fa-user"></i>
	              <p>
	                View Payment
	              </p>
					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
							  ...
							  <li class="breadcrumb-item"><a href="#">View Payment</a></li>
							</ol>
						</div><!-- /.col -->
					</div><!-- /.row -->
				</div><!-- /.container-fluid -->
								...
								<table class="table table-bordered">
			                        ...
			                        <tbody>
			                            ...
			                            <c:forEach var="fee" items="${listFee}">
			                                ...
			                                <tr>
			                                    <td>
			                                        <c:out value="${fee.feeid}" />
			                                    </td>
			                                    <td>
			                                        <c:out value="${fee.feedesc}" />
			                                    </td>
			                                    <td>
			                                        <c:out value="${fee.feetype}" />
			                                    </td>
			                                    <td>
			                                        <c:out value="${fee.feeamount}" />
			                                    </td>
			                                    <td>
			                                        <c:out value="${fee.adminid}" />
			                                    </td>
			                                    
			                                    <td><a href="listreceiptbyfeeid?id=<c:out value='${fee.feeid}' />">View Payment For This Fee</a></td>
			                                </tr>
			                            </c:forEach>
			                            <!-- } -->
			                        </tbody>
