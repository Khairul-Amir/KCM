						...
						<div class="col-md-12">
							<div class="card card-info">
								...
								<div class="card-body">
				                        ...
				                        <fieldset class="form-group">
				                            <label>Fee Amount</label> <input type="number" value="<c:out value='${fee.feeamount}' />" class="form-control" name="famount" required="required">
				                        </fieldset>
