...
<c:set var="userName" value="${logadmin.adminname}" scope="session" />
<c:set var="userID" value="${logadmin.adminid}" scope="session" />
</head>
<body>
	<div class="wrapper">
	    ...
	    <div class="sidebar">
	      ...
	      <nav class="mt-2">
	        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			  ...
			  <li class="nav-item">
	            <a href="<%=request.getContextPath()%>/showmainpage" class="nav-link active">
