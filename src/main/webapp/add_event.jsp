		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Add Event Details</h1>
						</div><!-- /.col -->
						<div class="col-sm-6">
						...
						<div class="col-md-12">
							<div class="card card-info">
								...
								<div class="card-body">
			                            ...
			                            <form action="addeventfee" method="post">
				
				                        <fieldset class="form-group">
				                            <label>Fee ID</label><br>
				                            <span><c:out value='${efee.feeid}' /></span> 
				                            <input type="hidden" value="<c:out value='${efee.feeid}' />" class="form-control" name="fid" required="required">
				                        </fieldset>
				                        
				                        <fieldset class="form-group">
				                            <label>Fee Description</label><br>
				                            <span><c:out value='${efee.feedesc}' /></span> 
				                        </fieldset>
				                        ...
				                        <fieldset class="form-group">
				                            ...
				                            <input type="text" class="form-control" name="edesc" required="required">
				                        </fieldset>
